...
void test_schnorr_adaptor_api(void) {
    ...
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_t(CTX, NULL, sig, msg, &pk[0]));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_t(CTX, t2, NULL, msg, &pk[0]));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_t(CTX, t2, sig, NULL, &pk[0]));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_t(CTX, t2, sig, msg, NULL));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_t(CTX, t2, sig, msg, &zero_pk));

    CHECK(secp256k1_schnorr_adaptor_adapt(CTX, sig64, sig, t32) == 1);
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_adapt(CTX, NULL, sig, t32));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_adapt(CTX, sig64, NULL, t32));
    ...
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_adaptor(CTX, NULL, sig, sig64));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_adaptor(CTX, adaptor, NULL, sig64));
    CHECK_ILLEGAL(CTX, secp256k1_schnorr_adaptor_extract_adaptor(CTX, adaptor, sig, NULL));
...
void test_schnorr_adaptor_vectors(void) {
    {
        ...
        const unsigned char sig64[64] = {
            0x61, 0x79, 0xDB, 0xF3, 0xE1, 0x32, 0x07, 0x85,
            0x3F, 0x88, 0x0C, 0x7A, 0x7A, 0x85, 0xEC, 0x67,
            0x8B, 0xAD, 0x64, 0xB8, 0x97, 0xF1, 0x08, 0xD4,
            0x76, 0x43, 0x8A, 0xC4, 0xA9, 0x32, 0xEE, 0x94,
            0x97, 0xCC, 0x73, 0xB8, 0xC3, 0x51, 0xF1, 0x89,
            0xB9, 0xD4, 0xFD, 0xE8, 0x93, 0xE3, 0x82, 0x0D,
            0x4B, 0xFF, 0x7F, 0x49, 0xD4, 0xBE, 0x1F, 0x8B,
            0x02, 0xCB, 0x80, 0x8C, 0xD3, 0x19, 0x23, 0x9E
        };
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x02, 0x42, 0x48, 0xD2, 0xD5, 0xD2, 0xF0, 0x31,
            0xA1, 0x88, 0xD0, 0x3F, 0x1D, 0x54, 0x3F, 0x6D,
            0x73, 0x74, 0x5E, 0xB8, 0xEF, 0x20, 0x5F, 0x20,
            0xC5, 0x23, 0x4C, 0x15, 0xD0, 0x21, 0x3A, 0xD9,
            0x5E, 0xC9, 0x63, 0x5F, 0x29, 0xE7, 0x81, 0x32,
            0xEF, 0x2A, 0xA6, 0xD2, 0xFC, 0x8B, 0x4E, 0x6F,
            0x67, 0x3A, 0x2F, 0x6D, 0x52, 0x85, 0xD3, 0x31,
            0xE7, 0x99, 0x4C, 0x23, 0x24, 0xB0, 0x9C, 0xEB, 0x1D
        };
        const unsigned char sig64[64] = {
            0x42, 0x48, 0xD2, 0xD5, 0xD2, 0xF0, 0x31, 0xA1,
            0x88, 0xD0, 0x3F, 0x1D, 0x54, 0x3F, 0x6D, 0x73,
            0x74, 0x5E, 0xB8, 0xEF, 0x20, 0x5F, 0x20, 0xC5,
            0x23, 0x4C, 0x15, 0xD0, 0x21, 0x3A, 0xD9, 0x5E,
            0xC9, 0x63, 0x5F, 0x29, 0xE7, 0x81, 0x32, 0xEF,
            0x2A, 0xA6, 0xD2, 0xFC, 0x8B, 0x4E, 0x6F, 0x67,
            0x3A, 0x2F, 0x6D, 0x52, 0x85, 0xD3, 0x31, 0xE7,
            0x99, 0x4C, 0x23, 0x24, 0xB0, 0x9C, 0xEB, 0x21
        };
        test_schnorr_adaptor_vectors_check_presigning(sk, pk, aux_rand, msg, t, sig);
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 1);
        test_schnorr_adaptor_vectors_check_adapt(sig, t32, sig64, 1);
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x03, 0xFC, 0xED, 0xA2, 0x9D, 0x85, 0x32, 0xD2,
            0xC1, 0x99, 0x70, 0xCC, 0x3F, 0x8C, 0x67, 0x91,
            0xCC, 0x41, 0xE3, 0x05, 0x59, 0xC6, 0xF6, 0x76,
            0x44, 0x46, 0x3B, 0x5A, 0x71, 0xC8, 0xE9, 0x9A,
            0x90, 0x5B, 0xA4, 0xDF, 0x9F, 0xA8, 0x76, 0xCC,
            0x4D, 0x1F, 0x8E, 0x5D, 0x74, 0x72, 0xED, 0x3D,
            0xB3, 0x59, 0x44, 0xD1, 0xC1, 0x6E, 0x92, 0x12,
            0xB4, 0xC4, 0x74, 0xCB, 0xDA, 0x9C, 0x1A, 0xA3, 0x22
        };
        const unsigned char sig64[64] = {
            0xFC, 0xED, 0xA2, 0x9D, 0x85, 0x32, 0xD2, 0xC1,
            0x99, 0x70, 0xCC, 0x3F, 0x8C, 0x67, 0x91, 0xCC,
            0x41, 0xE3, 0x05, 0x59, 0xC6, 0xF6, 0x76, 0x44,
            0x46, 0x3B, 0x5A, 0x71, 0xC8, 0xE9, 0x9A, 0x90,
            0x5B, 0xA4, 0xDF, 0x9F, 0xA8, 0x76, 0xCC, 0x4D,
            0x1F, 0x8E, 0x5D, 0x74, 0x72, 0xED, 0x3D, 0xB3,
            0x59, 0x44, 0xD1, 0xC1, 0x6E, 0x92, 0x12, 0xB4,
            0xC4, 0x74, 0xCB, 0xDA, 0x9C, 0x1A, 0xA3, 0x1C
        };
        test_schnorr_adaptor_vectors_check_presigning(sk, pk, aux_rand, msg, t, sig);
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 1);
        test_schnorr_adaptor_vectors_check_adapt(sig, t32, sig64, 1);
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x02, 0xA3, 0x96, 0xB0, 0x57, 0x1A, 0xD6, 0xC1,
            0xBC, 0x0A, 0x06, 0xA2, 0xDA, 0xFF, 0x1F, 0xB5,
            0xAB, 0x30, 0x60, 0x11, 0x86, 0xAA, 0x70, 0xE7,
            0x50, 0x8C, 0x84, 0xC2, 0xD6, 0x5E, 0xA6, 0x91,
            0x84, 0x05, 0x86, 0x63, 0x09, 0xF7, 0x63, 0x0F,
            0xA7, 0x61, 0x5D, 0x4E, 0xD0, 0xFB, 0x44, 0x20,
            0x8F, 0x35, 0x57, 0x02, 0x53, 0x91, 0xBD, 0xB7,
            0x22, 0x99, 0x2E, 0xD5, 0x62, 0xB2, 0x72, 0xDD, 0x25
        };
        const unsigned char sig64[64] = {
            0xA3, 0x96, 0xB0, 0x57, 0x1A, 0xD6, 0xC1, 0xBC,
            0x0A, 0x06, 0xA2, 0xDA, 0xFF, 0x1F, 0xB5, 0xAB,
            0x30, 0x60, 0x11, 0x86, 0xAA, 0x70, 0xE7, 0x50,
            0x8C, 0x84, 0xC2, 0xD6, 0x5E, 0xA6, 0x91, 0x84,
            0x05, 0x86, 0x63, 0x09, 0xF7, 0x63, 0x0F, 0xA7,
            0x61, 0x5D, 0x4E, 0xD0, 0xFB, 0x44, 0x20, 0x8F,
            0x35, 0x57, 0x02, 0x53, 0x91, 0xBD, 0xB7, 0x22,
            0x99, 0x2E, 0xD5, 0x62, 0xB2, 0x72, 0xDD, 0x27
        };
        test_schnorr_adaptor_vectors_check_presigning(sk, pk, aux_rand, msg, t, sig);
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 1);
        test_schnorr_adaptor_vectors_check_adapt(sig, t32, sig64, 1);
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x03, 0xA7, 0xFC, 0x93, 0x12, 0xDD, 0xAF, 0xF8,
            0xC9, 0x53, 0x3F, 0x9F, 0x73, 0x50, 0x04, 0x21,
            0xD4, 0xEB, 0xB7, 0x36, 0x3E, 0xFE, 0xA9, 0xE2,
            0x17, 0xCA, 0x70, 0xE5, 0xFE, 0xA1, 0xDC, 0xE4,
            0x3D, 0xC9, 0x51, 0xFE, 0x64, 0x5F, 0x33, 0x9C,
            0xC5, 0x80, 0x02, 0x0F, 0x7E, 0xFA, 0x3D, 0x04,
            0xAB, 0xBE, 0x63, 0xC9, 0x13, 0xF7, 0xD1, 0x59,
            0x66, 0x21, 0x4F, 0x63, 0x4A, 0xE0, 0x64, 0xE2, 0x21
        };
        const unsigned char sig64[64] = {
            0xA7, 0xFC, 0x93, 0x12, 0xDD, 0xAF, 0xF8, 0xC9,
            0x53, 0x3F, 0x9F, 0x73, 0x50, 0x04, 0x21, 0xD4,
            0xEB, 0xB7, 0x36, 0x3E, 0xFE, 0xA9, 0xE2, 0x17,
            0xCA, 0x70, 0xE5, 0xFE, 0xA1, 0xDC, 0xE4, 0x3D,
            0xC9, 0x51, 0xFE, 0x64, 0x5F, 0x33, 0x9C, 0xC5,
            0x80, 0x02, 0x0F, 0x7E, 0xFA, 0x3D, 0x04, 0xAB,
            0xBE, 0x63, 0xC9, 0x13, 0xF7, 0xD1, 0x59, 0x66,
            0x21, 0x4F, 0x63, 0x4A, 0xE0, 0x64, 0xE2, 0x1A
        };
        test_schnorr_adaptor_vectors_check_presigning(sk, pk, aux_rand, msg, t, sig);
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 1);
        test_schnorr_adaptor_vectors_check_adapt(sig, t32, sig64, 1);
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x02, 0x36, 0xF7, 0xE1, 0x79, 0x5A, 0x04, 0x98,
            0x76, 0x54, 0x4B, 0x25, 0x4C, 0xEA, 0x10, 0xD1,
            0x8E, 0xDE, 0x69, 0x67, 0xD1, 0x4A, 0x9F, 0x36,
            0x5D, 0x84, 0xFD, 0xF4, 0x38, 0x4C, 0x97, 0x7C,
            0x6A, 0x19, 0xC6, 0x05, 0x0F, 0x5C, 0x5A, 0xF5,
            0x61, 0x72, 0x0D, 0x2B, 0x0B, 0xA0, 0x6F, 0x5E,
            0xD8, 0x36, 0xE7, 0x15, 0xF2, 0xD5, 0xDA, 0xE8,
            0x96, 0x4C, 0x7F, 0x9F, 0x17, 0xFD, 0x0C, 0xF0, 0x90
        };
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x03, 0x40, 0x66, 0xF5, 0xBE, 0x7E, 0xD4, 0xB6,
            0xE0, 0x2E, 0xB3, 0x8B, 0x26, 0xFC, 0x0A, 0x8C,
            0xA8, 0x49, 0xA3, 0x2D, 0x7E, 0xCD, 0x64, 0x5B,
            0x49, 0xE4, 0x50, 0xFD, 0x5E, 0x06, 0x5A, 0x5E,
            0x77, 0xE4, 0x9E, 0xBB, 0x07, 0xC6, 0x37, 0xF9,
            0x99, 0x1C, 0xB2, 0x5A, 0x07, 0x7E, 0xE8, 0x46,
            0xE8, 0xA4, 0x50, 0xF7, 0xC7, 0x07, 0x0A, 0x86,
            0xC8, 0x58, 0xFF, 0xE6, 0x26, 0x9A, 0xF3, 0x53, 0xE1
        };
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 0);
    };
    {
        ...
        const unsigned char sig[65] = {
            0x03, 0x14, 0xDE, 0x03, 0xC2, 0x84, 0x36, 0xAB,
            0x9A, 0x24, 0x4F, 0xE3, 0x0F, 0x60, 0x92, 0x12,
            0x9B, 0xB1, 0xFF, 0x99, 0x73, 0x0F, 0xB7, 0xE4,
            0xEA, 0x59, 0x2B, 0x5B, 0xB2, 0xC5, 0xDD, 0xE4,
            0xF9, 0xED, 0x14, 0x0B, 0xA5, 0xE3, 0x2F, 0x25,
            0x0A, 0xE1, 0xCE, 0xF8, 0xE2, 0xC5, 0xD9, 0x75,
            0x63, 0xDC, 0x77, 0x66, 0x35, 0x83, 0xE5, 0xEC,
            0xA4, 0x0F, 0xFE, 0xC9, 0x79, 0xF5, 0xF3, 0x73, 0x8E
        };
        test_schnorr_adaptor_vectors_check_extract_t(pk, msg, sig, t, 0);
    };
    {
        ...
        const unsigned char sig[65] = {
            ...
            0x34, 0xED, 0x14, 0x0B, 0xA5, 0xE3, 0x2F, 0x25,
            0x0A, 0xE1, 0xCE, 0xF8, 0xE2, 0xC5, 0xD9, 0x75,
            0x63, 0xDC, 0x77, 0x66, 0x35, 0x83, 0xE5, 0xEC,
            0xA4, 0x0F, 0xFE, 0xC9, 0x79, 0xF5, 0xF3, 0x73, 0x8E
        };
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x02, 0xFA, 0x88, 0x46, 0x5F, 0xAF, 0x40, 0x88,
            0x31, 0x04, 0xFA, 0x0B, 0x77, 0xC1, 0x99, 0x0C,
            0xC1, 0xB2, 0xD7, 0x74, 0x56, 0xD1, 0x51, 0x86,
            0xCE, 0xF2, 0x40, 0xF6, 0x19, 0xE0, 0xFD, 0xED,
            0x82, 0xAA, 0x34, 0x62, 0xF8, 0x66, 0x63, 0x2C,
            0xB5, 0xAA, 0xDA, 0x9C, 0xB0, 0x43, 0x35, 0x93,
            0x75, 0xEC, 0x5C, 0xF2, 0x66, 0x6B, 0xFA, 0x71,
            0xDE, 0x84, 0xA5, 0x46, 0x83, 0x59, 0x9C, 0xD1, 0x5D
        };
        const unsigned char sig64[64] = {
            0xFA, 0x88, 0x46, 0x5F, 0xAF, 0x40, 0x88, 0x31,
            0x04, 0xFA, 0x0B, 0x77, 0xC1, 0x99, 0x0C, 0xC1,
            0xB2, 0xD7, 0x74, 0x56, 0xD1, 0x51, 0x86, 0xCE,
            0xF2, 0x40, 0xF6, 0x19, 0xE0, 0xFD, 0xED, 0x82,
            0x51, 0xD6, 0xAA, 0xF9, 0x84, 0xD5, 0x30, 0x37,
            0x13, 0xD5, 0x47, 0xC6, 0xB9, 0x50, 0x37, 0xF5,
            0x85, 0xB2, 0x20, 0x71, 0xCA, 0xF1, 0x08, 0x64,
            0x31, 0xB5, 0x5B, 0x4A, 0x58, 0x14, 0x85, 0x2D
        };
        test_schnorr_adaptor_vectors_check_adapt(sig, t32, sig64, 1);
        test_schnorr_adaptor_vectors_check_extract_adaptor(sig, sig64, t32, 1);
    };
    {
        ...
        const unsigned char sig[65] = {
            0x02, 0x2D, 0xB0, 0x2D, 0x30, 0x37, 0x63, 0xF5,
            0x12, 0xCB, 0x83, 0x02, 0x5E, 0x25, 0x16, 0x75,
            0xAB, 0xB8, 0x08, 0x82, 0x94, 0xFA, 0x06, 0x4D,
            0xE9, 0xB4, 0x63, 0x80, 0x69, 0x98, 0x2E, 0xC3,
            0x02, 0xD5, 0xC4, 0x2F, 0xB6, 0x91, 0x07, 0x17,
            0x38, 0xB1, 0x10, 0xDF, 0xB7, 0xDE, 0xBF, 0xAF,
            0x58, 0x8B, 0xC4, 0xB9, 0xDE, 0x93, 0x84, 0xCD,
            0xC4, 0x00, 0xD9, 0xDD, 0x78, 0x8E, 0xDD, 0xD0, 0xF4
        };
        const unsigned char sig64[64] = {
            0x2D, 0xB0, 0x2D, 0x30, 0x37, 0x63, 0xF5, 0x12,
            0xCB, 0x83, 0x02, 0x5E, 0x25, 0x16, 0x75, 0xAB,
            0xB8, 0x08, 0x82, 0x94, 0xFA, 0x06, 0x4D, 0xE9,
            0xB4, 0x63, 0x80, 0x69, 0x98, 0x2E, 0xC3, 0x02,
            0x0D, 0x5F, 0x66, 0x23, 0xC5, 0xF3, 0xFC, 0xC9,
            0x08, 0x56, 0x2B, 0xA9, 0xCF, 0x96, 0x91, 0x22,
            0xF2, 0x5E, 0x35, 0xA1, 0x1A, 0x86, 0x17, 0x1E,
            0x6A, 0x5E, 0xA3, 0x3D, 0x3E, 0x1D, 0x6B, 0xA3
        };
    ...
    };
    {
        ...
        const unsigned char sig[65] = {
            0x03, 0x2D, 0xB0, 0x2D, 0x30, 0x37, 0x63, 0xF5,
            0x12, 0xCB, 0x83, 0x02, 0x5E, 0x25, 0x16, 0x75,
            0xAB, 0xB8, 0x08, 0x82, 0x94, 0xFA, 0x06, 0x4D,
            0xE9, 0xB4, 0x63, 0x80, 0x69, 0x98, 0x2E, 0xC3,
            0x02, 0x2A, 0x3B, 0xD0, 0x49, 0x6E, 0xF8, 0xE8,
            0xC7, 0x4E, 0xEF, 0x20, 0x48, 0x21, 0x40, 0x50,
            0xA6, 0x2E, 0xEA, 0x23, 0x08, 0x1B, 0xC3, 0xD2,
            0x77, 0xBE, 0xF8, 0x81, 0x14, 0x41, 0x58, 0x70, 0x4D
        };
        const unsigned char sig64[64] = {
            0x2D, 0xB0, 0x2D, 0x30, 0x37, 0x63, 0xF5, 0x12,
            0xCB, 0x83, 0x02, 0x5E, 0x25, 0x16, 0x75, 0xAB,
