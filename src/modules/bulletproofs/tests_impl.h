...
static void test_bulletproofs_rangeproof_uncompressed_api(void) {
    ...
    CHECK(secp256k1_bulletproofs_rangeproof_uncompressed_prove(none, gens, secp256k1_generator_h, proof, &plen, 16, value, min_value, &commit, blind, nonce, enc_data, extra_commit, extra_commit_len) == 1);
    CHECK(secp256k1_bulletproofs_rangeproof_uncompressed_prove(vrfy, gens, secp256k1_generator_h, proof, &plen, 16, value, min_value, &commit, blind, nonce, enc_data, extra_commit, extra_commit_len) == 1);
