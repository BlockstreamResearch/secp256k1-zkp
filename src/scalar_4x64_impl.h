...
static int secp256k1_scalar_chacha20(secp256k1_scalar *r1, secp256k1_scalar *r2, const unsigned char *seed, uint64_t idx) {
    ...
    for (i = 0; i < MAX_ITER; i++) {
        ...
        r1_temp.d[3] = (((uint64_t)  x0) << 32) | x1;
        r1_temp.d[2] = (((uint64_t)  x2) << 32) | x3;
        r1_temp.d[1] = (((uint64_t)  x4) << 32) | x5;
        r1_temp.d[0] = (((uint64_t)  x6) << 32) | x7;
        r2_temp.d[3] = (((uint64_t)  x8) << 32) | x9;
        r2_temp.d[2] = (((uint64_t) x10) << 32) | x11;
        r2_temp.d[1] = (((uint64_t) x12) << 32) | x13;
        r2_temp.d[0] = (((uint64_t) x14) << 32) | x15;
